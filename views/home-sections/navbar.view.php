...
<!-- left side  -->
<div class="left-sdie -mb-2">
    <img src="/public/images/icons/a1-taxis-logo.png" alt="">
</div>
...
<div class="right-side mr-5 mt-5">
    <div class="hidden md:block">
        <ul class="flex items-center">
            ...
            <li class="text-lg mx-3 cursor-pointer hover:text-gray-700">Airport Transfer</li>
            <li class="text-lg mx-3 cursor-pointer hover:text-gray-700">Cities</li>
            <li class="text-lg mx-3 cursor-pointer hover:text-gray-700">Services</li>
            <li class="text-lg mx-3 cursor-pointer hover:text-gray-700">Blog</li>
